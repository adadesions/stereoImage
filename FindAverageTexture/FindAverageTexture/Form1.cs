...
namespace FindAverageTexture
{
    public partial class Form1 : Form
    {
        ...
        Triangle[] Triangles = new Triangle[60];
        ...
        public void PrepareTraiangle()
        {
            ...
            Triangles[0].x2 = init.PointX[1];
            Triangles[0].y2 = init.PointY[1];//p2
            Triangles[0].x3 = init.PointX[2];
            Triangles[0].y3 = init.PointY[2];//p3

            Triangles[1].x1 = init.PointX[1];
            Triangles[1].y1 = init.PointY[1];//p1
            Triangles[1].x2 = init.PointX[2];
            Triangles[1].y2 = init.PointY[2];//p2
            Triangles[1].x3 = init.PointX[3];
            Triangles[1].y3 = init.PointY[3];//p3

            Triangles[2].x1 = init.PointX[0];
            Triangles[2].y1 = init.PointY[0];//p1
            Triangles[2].x2 = init.PointX[2];
            Triangles[2].y2 = init.PointY[2];//p2
            Triangles[2].x3 = init.PointX[4];
            Triangles[2].y3 = init.PointY[4];//p3

            Triangles[3].x1 = init.PointX[0];
            Triangles[3].y1 = init.PointY[0];//p1
            Triangles[3].x2 = init.PointX[2];
            Triangles[3].y2 = init.PointY[2];//p2
            Triangles[3].x3 = init.PointX[5];
            Triangles[3].y3 = init.PointY[5];//p3

            Triangles[4].x1 = init.PointX[2];
            Triangles[4].y1 = init.PointY[2];//p1
            Triangles[4].x2 = init.PointX[4];
            Triangles[4].y2 = init.PointY[4];//p2
            Triangles[4].x3 = init.PointX[5];
            Triangles[4].y3 = init.PointY[5];//p3

            Triangles[5].x1 = init.PointX[1];
            Triangles[5].y1 = init.PointY[1];//p1
            Triangles[5].x2 = init.PointX[3];
            Triangles[5].y2 = init.PointY[3];//p2
            Triangles[5].x3 = init.PointX[6];
            Triangles[5].y3 = init.PointY[6];//p3

            Triangles[6].x1 = init.PointX[1];
            Triangles[6].y1 = init.PointY[1];//p1
            Triangles[6].x2 = init.PointX[6];
            Triangles[6].y2 = init.PointY[6];//p2
            Triangles[6].x3 = init.PointX[7];
            Triangles[6].y3 = init.PointY[7];//p3

            Triangles[7].x1 = init.PointX[2];
            Triangles[7].y1 = init.PointY[2];//p1
            Triangles[7].x2 = init.PointX[8];
            Triangles[7].y2 = init.PointY[8];//p2
            ...
            Triangles[9].x2 = init.PointX[9];
            Triangles[9].y2 = init.PointY[9];//p2
            Triangles[9].x3 = init.PointX[13];
            Triangles[9].y3 = init.PointY[13];//p3

            Triangles[10].x1 = init.PointX[3];
            Triangles[10].y1 = init.PointY[3];//p1
            Triangles[10].x2 = init.PointX[6];
            Triangles[10].y2 = init.PointY[6];//p2
            Triangles[10].x3 = init.PointX[9];
            Triangles[10].y3 = init.PointY[9];//p3

            Triangles[11].x1 = init.PointX[6];
            Triangles[11].y1 = init.PointY[6];//p1
            Triangles[11].x2 = init.PointX[7];
            Triangles[11].y2 = init.PointY[7];//p2
            Triangles[11].x3 = init.PointX[9];
            Triangles[11].y3 = init.PointY[9];//p3

            Triangles[12].x1 = init.PointX[4];
            Triangles[12].y1 = init.PointY[4];//p1
            Triangles[12].x2 = init.PointX[5];
            Triangles[12].y2 = init.PointY[5];//p2
            Triangles[12].x3 = init.PointX[8];
            Triangles[12].y3 = init.PointY[8];//p3
            ...
            Triangles[16].x1 = init.PointX[7];
            Triangles[16].y1 = init.PointY[7];//p1
            Triangles[16].x2 = init.PointX[9];
            Triangles[16].y2 = init.PointY[9];//p2
            Triangles[16].x3 = init.PointX[11];
            Triangles[16].y3 = init.PointY[11];//p3

            Triangles[17].x1 = init.PointX[4];
            Triangles[17].y1 = init.PointY[4];//p1
            Triangles[17].x2 = init.PointX[10];
            Triangles[17].y2 = init.PointY[10];//p2
            Triangles[17].x3 = init.PointX[12];
            Triangles[17].y3 = init.PointY[12];//p3

            Triangles[18].x1 = init.PointX[10];
            Triangles[18].y1 = init.PointY[10];//p1
            Triangles[18].x2 = init.PointX[12];
            Triangles[18].y2 = init.PointY[12];//p2
            Triangles[18].x3 = init.PointX[13];
            Triangles[18].y3 = init.PointY[13];//p3

            Triangles[19].x1 = init.PointX[11];
            Triangles[19].y1 = init.PointY[11];//p1
            Triangles[19].x2 = init.PointX[13];
            Triangles[19].y2 = init.PointY[13];//p2
            Triangles[19].x3 = init.PointX[14];
            Triangles[19].y3 = init.PointY[14];//p3

            Triangles[20].x1 = init.PointX[7];
            Triangles[20].y1 = init.PointY[7];//p1
            Triangles[20].x2 = init.PointX[11];
            Triangles[20].y2 = init.PointY[11];//p2
            Triangles[20].x3 = init.PointX[14];
            Triangles[20].y3 = init.PointY[14];//p3

            Triangles[21].x1 = init.PointX[4];
            Triangles[21].y1 = init.PointY[4];//p1
            Triangles[21].x2 = init.PointX[12];
            Triangles[21].y2 = init.PointY[12];//p2
            Triangles[21].x3 = init.PointX[15];
            Triangles[21].y3 = init.PointY[15];//p3

            Triangles[22].x1 = init.PointX[7];
            Triangles[22].y1 = init.PointY[7];//p1
            Triangles[22].x2 = init.PointX[14];
            Triangles[22].y2 = init.PointY[14];//p2
            ...
            Triangles[24].x3 = init.PointX[19];
            Triangles[24].y3 = init.PointY[19];//p3
            ...
            Triangles[29].x3 = init.PointX[20];
            Triangles[29].y3 = init.PointY[20];//p3
            ...
            Triangles[30].x3 = init.PointX[23];
            Triangles[30].y3 = init.PointY[23];//p3
            ...
            Triangles[31].x3 = init.PointX[23];
            Triangles[31].y3 = init.PointY[23];//p3

            Triangles[32].x1 = init.PointX[14];
            Triangles[32].y1 = init.PointY[14];//p1
            Triangles[32].x2 = init.PointX[17];
            Triangles[32].y2 = init.PointY[17];//p2
            Triangles[32].x3 = init.PointX[18];
            Triangles[32].y3 = init.PointY[18];//p3
            ...
            Triangles[34].x2 = init.PointX[24];
            Triangles[34].y2 = init.PointY[24];//p2
            Triangles[34].x3 = init.PointX[27];
            Triangles[34].y3 = init.PointY[27];//p3

            Triangles[35].x1 = init.PointX[19];
            Triangles[35].y1 = init.PointY[19];//p1
            Triangles[35].x2 = init.PointX[22];
            Triangles[35].y2 = init.PointY[22];//p2
            Triangles[35].x3 = init.PointX[24];
            Triangles[35].y3 = init.PointY[24];//p3
            ...
            Triangles[36].x3 = init.PointX[25];
            Triangles[36].y3 = init.PointY[25];//p3

            Triangles[37].x1 = init.PointX[19];
            Triangles[37].y1 = init.PointY[19];//p1
            Triangles[37].x2 = init.PointX[20];
            Triangles[37].y2 = init.PointY[20];//p2
            Triangles[37].x3 = init.PointX[25];
            Triangles[37].y3 = init.PointY[25];//p3

            Triangles[38].x1 = init.PointX[20];
            Triangles[38].y1 = init.PointY[20];//p1
            Triangles[38].x2 = init.PointX[21];
            Triangles[38].y2 = init.PointY[21];//p2
            ...
            Triangles[39].x3 = init.PointX[26];
            Triangles[39].y3 = init.PointY[26];//p3

            Triangles[40].x1 = init.PointX[23];
            Triangles[40].y1 = init.PointY[23];//p1
            Triangles[40].x2 = init.PointX[26];
            Triangles[40].y2 = init.PointY[26];//p2
            Triangles[40].x3 = init.PointX[29];
            Triangles[40].y3 = init.PointY[29];//p3

            Triangles[41].x1 = init.PointX[23];
            Triangles[41].y1 = init.PointY[23];//p1
            Triangles[41].x2 = init.PointX[29];
            Triangles[41].y2 = init.PointY[29];//p2
            Triangles[41].x3 = init.PointX[30];
            Triangles[41].y3 = init.PointY[30];//p3
            ...
            Triangles[43].x1 = init.PointX[21];
            Triangles[43].y1 = init.PointY[21];//p1
            Triangles[43].x2 = init.PointX[23];
            Triangles[43].y2 = init.PointY[23];//p2
            Triangles[43].x3 = init.PointX[26];
            Triangles[43].y3 = init.PointY[26];//p3

            Triangles[44].x1 = init.PointX[24];
            Triangles[44].y1 = init.PointY[24];//p1
            Triangles[44].x2 = init.PointX[27];
            Triangles[44].y2 = init.PointY[27];//p2
            Triangles[44].x3 = init.PointX[28];
            Triangles[44].y3 = init.PointY[28];//p3
            ...
            Triangles[50].x2 = init.PointX[29];
            Triangles[50].y2 = init.PointY[29];//p2
            Triangles[50].x3 = init.PointX[33];
            Triangles[50].y3 = init.PointY[33];//p3

            Triangles[51].x1 = init.PointX[27];
            Triangles[51].y1 = init.PointY[27];//p1
            Triangles[51].x2 = init.PointX[28];
            Triangles[51].y2 = init.PointY[28];//p2
            Triangles[51].x3 = init.PointX[35];
            Triangles[51].y3 = init.PointY[35];//p3

            Triangles[52].x1 = init.PointX[28];
            Triangles[52].y1 = init.PointY[28];//p1
            Triangles[52].x2 = init.PointX[31];
            Triangles[52].y2 = init.PointY[31];//p2
            Triangles[52].x3 = init.PointX[35];
            Triangles[52].y3 = init.PointY[35];//p3

            Triangles[53].x1 = init.PointX[31];
            Triangles[53].y1 = init.PointY[31];//p1
            Triangles[53].x2 = init.PointX[34];
            Triangles[53].y2 = init.PointY[34];//p2
            Triangles[53].x3 = init.PointX[35];
            Triangles[53].y3 = init.PointY[35];//p3

            Triangles[54].x1 = init.PointX[31];
            Triangles[54].y1 = init.PointY[31];//p1
            Triangles[54].x2 = init.PointX[32];
            Triangles[54].y2 = init.PointY[32];//p2
            Triangles[54].x3 = init.PointX[34];
            Triangles[54].y3 = init.PointY[34];//p3

            Triangles[55].x1 = init.PointX[32];
            Triangles[55].y1 = init.PointY[32];//p1
            Triangles[55].x2 = init.PointX[33];
            Triangles[55].y2 = init.PointY[33];//p2
            Triangles[55].x3 = init.PointX[34];
            Triangles[55].y3 = init.PointY[34];//p3

            Triangles[56].x1 = init.PointX[32];
            Triangles[56].y1 = init.PointY[32];//p1
            Triangles[56].x2 = init.PointX[34];
            Triangles[56].y2 = init.PointY[34];//p2
            Triangles[56].x3 = init.PointX[36];
            Triangles[56].y3 = init.PointY[36];//p3

            Triangles[57].x1 = init.PointX[29];
            Triangles[57].y1 = init.PointY[29];//p1
            Triangles[57].x2 = init.PointX[33];
            Triangles[57].y2 = init.PointY[33];//p2
            Triangles[57].x3 = init.PointX[36];
            Triangles[57].y3 = init.PointY[36];//p3

            Triangles[58].x1 = init.PointX[29];
            Triangles[58].y1 = init.PointY[29];//p1
            Triangles[58].x2 = init.PointX[30];
            Triangles[58].y2 = init.PointY[30];//p2
            Triangles[58].x3 = init.PointX[36];
            Triangles[58].y3 = init.PointY[36];//p3

            Triangles[59].x1 = init.PointX[34];
            Triangles[59].y1 = init.PointY[34];//p1
            Triangles[59].x2 = init.PointX[35];
            Triangles[59].y2 = init.PointY[35];//p2
        ...
        public void get_pixel()
        {
            ...
            for (int x = 0; x < myBitmap.Width; x++)
            {
                ...
                {
                    Color colorpixel = myBitmap.GetPixel(x, y);
                    // things we do with pixelColor                   
                    //Console.WriteLine(colorpixel.R);                    

                    //for triangle
                    //U x V = Ux*Vy-Uy*Vx
                    for(int tri = 0; tri < 59; tri++)
                    {
        ...
        private void Average_Click(object sender, EventArgs e)
        {
            ...
            {
                sourceMatrix[i] = new int[129575]; //จำนวนมิติ หรือ ค่าระบุตำแหน่งจุดบนหน้า x1-x37 ,y1-y37 ,z1-z37
            }
            ...
            int[][] SumOf1Point = new int[129575][]; //129575 from 355*365 pixel
            for (int i = 0; i < 129575; i++)
            {
                SumOf1Point[i] = new int[NumberOfFaceMax];
            }
