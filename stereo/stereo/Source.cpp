...
"{@left          |../image/10L.jpg | left view of the stereopair                                       }"
"{@right         |../image/10R.jpg | right view of the stereopair                                      }"
"{GT             |../image/New10.png| optional ground-truth disparity (MPI-Sintel or Middlebury format) }"
...
int main(int argc, char** argv)
{
	...
	bool noGT;
	Mat GT_disp;
	if (GT_path == "../image/10N.png" && left_im != "../image/10L.jpg")
		noGT = true;
	else
	{
		noGT = false;
